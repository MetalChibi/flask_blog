...
# Variable with connection to the database file `database.db` which will be created as soon as py file is run.
...
# Cursor object is created in line 13 (cur=...) but wtf is a cursor method
